                    ...
                    <form method="POST" action="UserController.php">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-icon">
                                        <input class="input--style-4 js-datepicker" type="text" name="BD">
                        ...
                        <div class="col-2">
                            <div class="input-group">
                                ...
                                <input class="input--style-4" type="text" name="HAddress" style="width:550px;">
                            </div>
                        </div>
                        <div class="col-2">
                            <div class="input-group">
                                <label class="label">Work Address</label>
                                <input class="input--style-4" type="text" name="WAddress"  style="width:550px;">
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                        ...
                        <div class="input-group">
                            ...
                            <label class="label">Contacting Method</label>
                            <div class="rs-select2 js-select-simple select--no-search">
                                <select name="Method">
                                    <?php 
                                    for($i=0;$i<count($US);$i++){
                                    echo "<option value=".$US[$i]->id.">" . $US[$i]->ContactMethod."</option>";
                                    }
                                    ?>
                                </select>
